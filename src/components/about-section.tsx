                    ...
                    <AnimatedGroup
                        ...
                        <div className="relative space-y-4">
                            <p className="text-muted-foreground">
                                I am a dynamic and passionate Software Developer with a proven track record of creating and implementing innovative solutions. My expertise lies in{' '}
                                <span className="text-foreground font-bold">
                                    Java, Spring Boot, and Node.js
                                </span>
                                , complemented by a strong proficiency in machine learning and AWS cloud services. I thrive on enhancing team efficiency and delivering high-quality projects.
                            </p>
